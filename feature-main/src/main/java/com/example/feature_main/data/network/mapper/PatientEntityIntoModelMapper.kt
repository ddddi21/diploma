package com.example.feature_main.data.network.mapper

import com.example.feature_main.data.network.response.FilmDto
...
class PatientEntityIntoModelMapper @Inject constructor() : BaseSingleModelMapper<FilmDto, Film> {
