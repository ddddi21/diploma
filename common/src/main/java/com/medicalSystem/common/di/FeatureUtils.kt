...
object FeatureUtils {
    ...
    private fun getHolder(context: Context): com.medicalSystem.common.di.FeatureContainer {
        return context.applicationContext as com.medicalSystem.common.di.FeatureContainer
    }
}